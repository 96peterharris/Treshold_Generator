...
public class LFSR {
    ...
    public LFSR() throws NoSuchAlgorithmException {
        this.numOfReg = 0;
    ...
    public void clearArrays(){
        this.processedRegs.clear();
        this.arrLenArray.clear();
        this.initialArrays.clear();
        this.resultArr.clear();
    }

    public void executeRandom() throws NoSuchAlgorithmException {
        this.metaData.clear();
        randomSizeArray();
        initial();
        randomInitial();
    ...
    public void executeOne() throws NoSuchAlgorithmException {
        this.metaData.clear();
        randomSizeArray();
        initial();
        splitToMeta();
    ...
    public String getResult(){ arrToString(); return this.result;}
